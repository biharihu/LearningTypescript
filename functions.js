...
var addStrings = function (str1, str2) {
    if (str1 === void 0) { str1 = "Akash"; }
    if (str2 === void 0) { str2 = "Singh"; }
    return str1 + " " + str2;
};
...
var getName = function (user) {
    var _a, _b;
    return ((_a = user === null || user === void 0 ? void 0 : user.first) !== null && _a !== void 0 ? _a : "Akash") + " " + ((_b = user === null || user === void 0 ? void 0 : user.last) !== null && _b !== void 0 ? _b : "Singh");
};
